...
\cvskillentry{}{4.5}{AmigaOS}{20}{I've been developing games most of my life}% Half-integer skill level allowed when using document class option 'circle' (default in contemporary style)
\cvskillentry*[1em]{Methods}{4}{SCRUM}{8}{SCRUM master for 5 years}
% \cvskill{<0-5>} command
 \cvitem{\textbackslash{cvskill}:}{Skills can be visually expressed outside the skill matrix by the \textbackslash{cvskill} command, e.g. \cvskill{2} \cvskill{3.5} half-integer skill levels are allowed only when using document class option 'circle' (default in contemporary style)}
